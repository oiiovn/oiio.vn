<div class="content__ads" style="display:flex;background:#E9E9E9;">
    ...
    <table class="index-mobile" style="width:100%;background: #fff;">
        ...
        <tr class="mobile-modal-body" style="display:flex;padding-left: 10px;padding-right: 10px;" data-toggle="modal"
            ...
            <td class="body-content" style="text-align:right;position: absolute;right: 20px;">
                ...
                <div class="items fs13" style="color: #DE8C49;font-style: normal;font-weight: 400;line-height: normal;">
                    Đơn giao nhanh</div>
                    ...
                    <td class="body-text" style=" width: 100%;">
                        <ul class="items fs12" style="list-style-type: disc;z-index:999;">
                            ...
                            <li
                                ...
                                <input type="checkbox" class="checkbox" required=""
                                    style="margin-bottom:5px;margin-right:8px;" />Nếu bạn tiếp tục, bạn phải tuân thủ
                        ...
                        <div class="items" style="padding-top:17px;display:flex;padding-left:100px;">
                            <a href="#"><button type="button" class="btn btn-secondary fs14" data-dismiss="modal"
                                    style="border-radius: 5px;border: 1.5px solid #A6A4A4;background:none;color: #A6A4A4;font-style: normal;font-weight: 700;line-height: normal;height:32px;width:65px;">Hủy</button></a>
            ...
            <table class="modal-content" style=" width:54rem;">
                ...
                <tr class="modal-body" style="display:flex;">
                    ...
                    <td class="body-content" style="text-align:right;">
                        ...
                        <div class="items">Không nhận hàng</div>
                        <div class="items fs13"
                            style="color: #DE8C49;font-style: normal;font-weight: 700;line-height: normal;">Đơn giao
                            nhanh</div>
                        <div class="items">Shop thanh toán</div>
                        <div class="items">Shop gửi đánh giá</div>
                        <div class="items"
                    ...
                    <td class="body-text" style="padding-left:10%; width: 50%;">
                        ...
                        <div class="items fs14"
                            ...
                            • Yêu cầu tài khoản đặt là tài khoản hạng vàng đối với Shopee, đối với các nền tảng khác chỉ
                            cần có avatar và tên người dùng thật<br>
                            • Địa chỉ lên đơn là Hà Nội<br>
                            <input type="checkbox" class="checkbox" required=""
                                style="margin-bottom:5px;margin-right:8px;font-weight: 700;" />Nếu bạn tiếp tục, bạn
                            phải tuân thủ theo chính sách của chúng tôi.
    ...
    <div class=" content-ads index-web shadow-sm"
        style="margin-left:22px;width:200px;height:290px;background:#FFF;border-radius:10px;    position: absolute;right: 0px;">
        <a href="https://shopee.vn/%C3%81o-thun-Unisex-m%C3%A1c-RealLife-cao-su-FKZ-Unisex-ph%C3%B4ng-tr%C6%A1n-nam-n%E1%BB%AF-tay-l%E1%BB%A1-oversize-form-r%E1%BB%99ng-i.183840366.23825993719?sp_atk=af391579-fcac-4eb1-b2ce-358e20fcc785&xptdk=af391579-fcac-4eb1-b2ce-358e20fcc785"
            ...
            <div class="ads-content" style="display:left !important;">
                <div
                    style="border-radius: 3px 0px 0px 3px;border: 1px solid rgba(0, 0, 0, 0.50);border-right:none;width:36px;height:23px;margin-left:5px;color: #000;font-size: 11px;font-style: normal;font-weight: 400;line-height: normal;text-align:center;padding:3px;">
                    30%</div>
                <div
