...
<div class="row mb-3">
    {{-- <div class="col-12 col-md-6 mb-mobi">
        <p class="text-orange btn-yellow-light">{{__('Tiền mua SP:')}}
    <strong>{{ format_price($job->money_product) }}</strong></p>
</div> --}}
<div class="col-12 col-md-12" style="width:96.1%; margin:auto;">
    <div
        class="d-flex flex-column flex-md-row justify-content-between align-items-center bg-success-light btn-yellow-light">
