...
<div style="width:150%;">
    ...
    <div style="display:flex;">
        <div style="width: 681px;height: 560px;border-radius: 10px;background: #FFF;">
            ...
            <div class="sim-code_content"
                style="display: grid;grid-template-columns: auto auto auto;margin-top:25px;height:410px;margin-left:10px;">
                <div class="grid-item"
                    style="width:196px;height:46px;margin-left:10px;margin-bottom:20px;border: 1px solid gray; border-radius:5px;display:flex;justify-content: space-between;">
        ...
        <div style="width:450px;height:560px;border-radius: 10px;background: #FFF;margin-left:23px;">
            ...
            <div style="margin-left:43px;margin-top:20px;margin-bottom:20px;"><span
                    style="color: #000;font-size: 16px;font-style: normal;font-weight: 700;line-height: normal;">Mua
                    nhanh</span></div>
            <div style="display: grid;grid-template-columns: 50% 50%;margin-left:43px;">
                <div
    ...
    <div style="width: 1160px;height: 476px;border-radius: 10px;background: #FFF;margin-top:20px;">
        <div style="padding-left:20px;padding-top:20px;padding-bottom:20px;"><span
                style="color: #303030;font-size: 16px;font-style: normal;font-weight: 600;line-height: normal;">Tin
        ...
        <div
            ...
            <div style="display:flex;width:150px;">
                <img src="{{ asset('viewsCustom/assets/images/icon-lazada.svg') }}" style="width:30px; height:30px;" />
                <span style="margin-left:10px;">lazada</span>
            </div>
        ...
        <div
            style="padding-top:20px;display:flex;width: 90%;margin: auto;justify-content: space-around;height: 70px;border-bottom: 1px solid gray;">
            <div style="display:flex;width:150px;">
                <img src="{{ asset('viewsCustom/assets/images/icon-zalo.svg') }}" style="width:30px; height:30px;" />
                <span style="margin-left:10px;">Zalo</span>
            </div>
            <div style="width: 120px;"><span
        ...
        <div
            style="padding-top:20px;display:flex;width: 90%;margin: auto;justify-content: space-around;height: 70px;border-bottom: 1px solid gray;">
            <div style="display:flex;width:150px;">
                <img src="{{ asset('viewsCustom/assets/images/icon-shoppe.svg') }}" style="width:30px; height:30px;" />
