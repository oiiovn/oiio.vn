...
<body>
<div class="container-scroller" style="overflow-y: hidden !important;margin-left:50px;">
    <div class="container-fluid page-body-wrapper">
        <div class="content-wrapper d-flex align-items-center auth">
            
            <div class="row flex-grow">
                <div class="col-lg-4 mx-auto" style="width:60%;">
...
<div class="form-login" style="width:60%;background:#fff;margin:auto;">
                            <div class="auth-form-light text-left p-4" style="border-radius: 10px">
                        <div class="brand-logo">
                            <img src="{{ asset('icon/logoPagesAuth.png') }}" alt="logo">
                        </div>
