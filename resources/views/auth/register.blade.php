    ...
    <div class="container-fluid page-body-wrapper">
        <div class="content-wrapper d-flex align-items-center auth">
            <div class="row flex-grow">
                <div class="col-lg-4 mx-auto" style="width:70%;">
                        ...
                        <x-form class="web" type="post" :validate="true" style="font-family: 'Lato', sans-serif">
                            <div class="mb-3" style="margin-top: 15px;">
                                <x-input class="form-control form-control-flush" type="text" name="fullname" placeholder="Họ và tên" required
                                       style="height: 40px !important; flex-shrink: 0; border-radius: 5px; border: 1px solid #C7C6C1; font-family: 'Lato', sans-serif;"/>
                            </div>
                            ...
                            <button type="submit" class="btn-warning"
                                    style="width: 100%; height: 40px; flex-shrink: 0; border-radius: 5px; margin-top: 10px;
