        ...
        <x-form type="post" :validate="true" action="{{ route('user.post_shop') }}" class="" style="display:flex;width:100%;">
            ...
            <div style="display:block;width:100%;" class="">
                <div class="mb-3 w-form pd-form" style="">           
                    <x-input class="w-100" name="name_shop" placeholder="VD: Làn Sóng Xanh" :required="true" style="margin-top: -10px;color: rgba(48, 48, 48, 0.20);font-size: 16px;font-style: normal;font-weight: 500;line-height: normal;height:46px;" />
                </div> 
