...
<div class="all__info-shop" style=" width:100%;">
    <div style="display:block;margin-bottom:20px;width:100%;">
        <div class="info-shop" style="display:flex;background:#fff;margin-bottom:20px;border-radius:10px;width:100%;">
            <div class="header-left-pp__img-info-shop">
                <img class="images-header-info-shop" src="{{ asset('viewsCustom/assets/images/hinh1.svg') }}"  style="border:2px solid #FB6815; border-radius:50%;"/>
            </div>
            <div class="header-mid-text-info-shop">
                ...
                <div class="header-right-info-shop" style="display:flex;">
            ...
            <div class="header-right-text"style="color: #303030; font-size: 16px; font-style: normal; font-weight: 400; line-height: normal; width: 272px; text-align: right; display: flex; flex-direction: column;">
    ...
    <div class=" content-ads index-web shadow-sm" style="margin-left:22px;width:200px;height:290px;background:#FFF;border-radius:10px;">
            ...
            <!-- đánh giá -->
        <div class="reviews" style="background: #fff;border-radius: 10px;padding-bottom: 80px">
