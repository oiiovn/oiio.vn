...
<div style="display:flex;margin-bottom:20px;background:#fff;border-radius:10px;">
<div class="info-shop" style="height:200px;display:flex;">
    <div class="header-left-pp__img" style="padding-left:42px;padding-top:24px;">
        <img src="{{ asset('viewsCustom/assets/images/hinh1.svg') }}"  style="width:150px;height:150px;border:2px solid #FB6815; border-radius:50%;"/>
    </div>
    <div class="header-mid-text" style="padding-left:20px;padding-top:32px;" >
        <div style="display:flex;padding-bottom:12px;">
            <div class="header-left-pp__text__top " style="font-size:24px;color: #000;font-style: normal;font-weight: 500;line-height: normal;max-width:200px;"><b>Korina</b></div>
            <img style="padding-left:4px;" src="{{ asset('viewsCustom/assets/images/tick.svg') }}" />
        </div>
        <div class="header-right-pp" style="display:flex;padding-bottom:35px;">
            <div ><img src="{{ asset('viewsCustom/assets/images/Vector.svg') }}" width:15px height:15px style="margin-bottom:7px;"/></div>
            <div class="" style="font-size:16px;color: #D0011B;font-style: normal;font-weight: 400;line-height: normal;padding-left:8px;">4.5</div>
            <div class="" style="font-size:16px;color: #D0011B;font-style: normal;font-weight: 400;line-height: normal;width: 150px;padding-left:3px;">(25,5k đánh giá)</div>
        </div>
    ...
    <div class="header-right-text"style="color: #303030; text-align: right; font-size: 16px; font-style: normal; font-weight: 400; line-height: normal; width: 272px; text-align: right; padding-top: 32px; display: flex; flex-direction: column; margin-left:120px;">
        <div style="display:flex;padding-bottom:20px;justify-content: flex-end;">
            <span>vubui.7592@gmail.com</span>
            <img style="padding-left:16px;" src="{{ asset('viewsCustom/assets/images/mail.svg') }}" style="width:16px;height:14px;"/>
        </div>
        <div style="display:flex;padding-bottom:20px;justify-content: flex-end;">
            <span>Gò Vấp, Hồ Chí Minh</span>
            <img style="padding-left:16px;" src="{{ asset('viewsCustom/assets/images/diachi.svg') }}" style="width:13px;height:18px;"/>
        </div>
        <div style="display:flex;padding-bottom:20px;justify-content: flex-end;">
            <span>093 458 4939</span>
            <img style="padding-left:16px;" src="{{ asset('viewsCustom/assets/images/phone.svg') }}" style="width:20px;height:20px;"/>
        </div>
        <div style="display:flex;justify-content: flex-end;">
            <span>Chưa cập nhật</span>
            <img style="padding-left:16px;" src="{{ asset('viewsCustom/assets/images/facebook.svg') }}" style="width:20px;height:20px;"/>
        </div>
    </div>
</div>
<!-- đánh giá -->
<div style="background: #fff;width:334px;border-radius: 10px;position:absolute;right:0px;padding-bottom: 80px">
        ...
        <div class="content__body-content" style="display:flex;padding-top:4.93%;padding-left:4.1%;">
                ...
                <div class="content__body-content__btn" style="text-align: right; margin-left:13.14%;">
                    ...
                    <div class="btn-receive-application" style="width:105px;">
                        <a href="#nhan-don"><button type="button" class="btn fs14 font-lato" data-toggle="modal" data-target="#exampleModalCenter" style="border-radius: 5px;border-radius: 5px;background: #F5AE5D;color: #FFF;font-style: normal;font-weight: 700;line-height: normal;width:105px;height:43px;padding:12px;" >Nhận Đơn</button></a>
                    </div>
                </div>
        </div>
    </div>
        ...
        <div class="modal-content" style="padding:5%;">
                            <div class="modal-header" style="padding:0px 0px 0px 30px">
                                <div class="items" style="display:flex; padding-top:5px;padding-left:5px;">
                                    ...
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"  style="border: none;background:none; position: absolute;right: 17px;top: 22px;"><span aria-hidden="true"><img src="{{ asset('viewsCustom/assets/images/clone.svg') }}" ></span> </button>
                                </div>
                            </div>
            ...
            <div class="modal-body" style="display:flex;">
                ...
                <div class="body-text" style="padding-left:10%; width: 50%;">
                    ...
                    <div class="items fs14" style="color: #303030;text-align: justify;font-style: normal;font-weight: 400;line-height: 164%; /* 22.96px */letter-spacing: 0.7px;">	• Người đặt không cần phải nhận hàng <br>
                        ...
                        <input type="checkbox" class="checkbox" required=""  style="margin-bottom:5px;margin-right:8px;font-weight: 700;"/>Nếu bạn tiếp tục, bạn phải tuân thủ theo chính sách của chúng tôi.
