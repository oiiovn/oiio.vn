...
<div class="container-slug" style="width:136%;display:flex;justify-content: center;align-items: center;">
    <div style="display:block;width:60.43%;">
        <div class="slug-header" style="width:100%;padding:15px 20px;">
            ...
            <div style="width:100%; height: 83px; background: rgba(195, 195, 195, 0.15); border-radius: 5px; border: 0.50px rgba(48, 48, 48, 0.20) solid;display:flex;justify-content: space-between;padding:15px 20px;align-items: center;">
