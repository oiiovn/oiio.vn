                ...
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Danh sách lệnh rút') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header justify-content-between">
                    <h2 class="mb-0">{{ __('Danh sách lệnh rút') }}</h2>
...
@include('admin.transaction.withdrawn.scripts.datatable')
<script>
$(document).ready(function(){
    // define columns for the datatables
    columns = window.LaravelDataTables["withdrawnTable"].columns();
